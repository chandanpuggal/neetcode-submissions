...
public:
    ...
    void reorderList(ListNode* head) {
        ...
        while (currentPosition <= (size - 1)/ 2) {
            ...
            // Incase there are odd elements, Curr and nxt would point to each other in middle
            // Since both are same. Ex [1,2,3,4,5]
            current->next = nxt;
        ...
        // Incase there are odd elements, Curr and nxt would point to each other.
        // hence, we need to break the cycle.
        temp->next = NULL;
    }
};
